...
# JRE Version (experimental)
class AXLDataModel(dict):
    """JRE redo of AXLDataModel with lower expectations due to Mutable Mapping issues"""
    ...
    def sanitize(self):
        ...
        """
        return sanitize_model_dict(self)
...
# Original JELS version (issues with MutableMapping)
class AXLDataModel_jels(MutableMapping):
